...
def summarize_news(news_text):
  print("🤖 Gemini AI가 친근한 경제 블로그 스타일로 요약하는 중...")
  prompt = f"""
    다음은 최근 주요 경제 뉴스 목록입니다. 
    이 내용들을 바탕으로 일반 독자들이 쉽고 흥미롭게 읽을 수 있는 트렌디한 경제 블로그 글 형식으로 요약해 주세요.
    
    - 어조: 딱딱한 보고서 톤 대신, 경제에 관심 많은 친구에게 이야기하듯 친근하고 부드러운 어조(~해요, ~랍니다 등)로 작성해 주세요.
    - 주요 경제 뉴스 5가지를 뽑아서, 각 뉴스 제목은 <h3> 태그를 사용하고 앞에 📈 아이콘을 붙여서 호기심을 유발해 주세요.
    - 본문 내용은 <ul>과 <li> 태그를 사용하여 핵심 내용 위주로 2~3개의 깔끔한 포인트로 정리해 주세요.
    - 중요한 경제 키워드나 수치(금리, 지수, 퍼센트 등)는 <strong> 태그로 콕 집어 강조해 주세요.
    - 전체 내용 끝에 독자들에게 가볍게 건네는 오늘의 경제 인사이트나 한 줄 소감을 <p><i>...</i></p> 태그로 덧붙여 주세요.
