...
def summarize_news(news_text):
  ...
  prompt = f"""
    ...
    1. 도입부: 전일 마감한 미국 주식시장(뉴욕증시) 상황 요약
       - <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin-bottom: 20px;">
         <h3>🇺🇸 전일 미국 증시 마감 체크포인트</h3>
         - 다우, S&P 500, 나스닥 등 주요 지수의 마감 흐름과 분위기를 가볍고 친근한 어조(~해요)로 요약해 주세요.
         - 시장을 흔들었던 핵심 특이사항이나 이슈 2~3가지를 <ul>과 <li> 태그를 사용해 깔끔하게 짚어주세요.
         </div>

    2. 본문: 주식 시장에 미치는 파급 효과가 **가장 큰 순서(임팩트 1위부터 5위)**로 엄선한 국내외 주요 경제 뉴스
       - 총 5가지 뉴스를 순서대로 나열해 주세요.
       - 각 뉴스 제목은 <h3> 태그를 사용하고 앞에 📈 아이콘과 순위(예: 1위, 2위...)를 붙여주세요. (예: <h3>📈 1위: 타이틀내용</h3>)
    ...
    3. 마무리: 오늘 장을 시작하는 투자자들을 위한 한 줄 인사이트 및 코멘트
